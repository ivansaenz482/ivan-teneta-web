      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <h2 className="mt-6 font-display text-3xl font-bold sm:text-5xl">
            Soluciones <span className="text-gold-gradient">tecnológicas</span> de alto nivel
          </h2>
        ...
        <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {SERVICES.map((service, i) => {
            ...
            return (
              ...
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-gold-400 to-gold-600 text-ink-950 shadow-[0_0_24px_rgba(250,204,21,0.35)]">
                ...
                <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-gold-400/70 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
              </motion.article>
            )
          })}
        </div>
