          ...
          {channels.map((channel, i) => {
            ...
            const inner = (
              <div className="neon-border group flex h-full items-center gap-5 rounded-2xl bg-ink-900/80 p-6 backdrop-blur">
                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-aqua-400 to-aqua-600 text-ink-950 shadow-[0_0_20px_rgba(250,204,21,0.3)]">
